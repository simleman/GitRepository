...
.x-form-check-wrap{padding-top: 0px;}
...
Ext.onReady(function() {
	...
	questiontype.on('select',function(){
	  store.each(function(record) {   
		     if(record.get("qtid")==questiontype.getValue()){
		    	var i=0;
		    	if(record.get("isjudge")==1){
		    		abutton.hide();
		    		rbutton.hide();
		    		arlabel.hide();
		    		plabel.hide();
		    		...
		    		var answercount = record.get("anwsercount");
